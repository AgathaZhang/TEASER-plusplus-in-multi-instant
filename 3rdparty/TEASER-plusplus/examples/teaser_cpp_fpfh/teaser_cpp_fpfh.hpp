...
Eigen::Matrix4d map_icp_teaser_icp(pcl::PointCloud<pcl::PointXYZINormal>::Ptr& source_merge_cloud, pcl::PointCloud<pcl::PointXYZINormal>::Ptr& target_merge_cloud,float scale_value = 10);